...
function recoverChatMessages(chatID, currentUserEmail) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    return [4 /*yield*/, (0, connectDatabase_1.connectDatabase)().then(function () {
                            console.log("✅ Database connected successfully for recoverChatMessages");
                        })];
                case 1:
                    _a.sent(); // Ensure the database connection is established
                    return [4 /*yield*/, messages_1.Message.find({ chatID: chatID }).sort({ TimeStamp: 1 })];
                case 2:
                    messages = _a.sent();
                    return [2 /*return*/, messages];
                case 3:
                    error_1 = _a.sent();
                    console.error("Error al recuperar los mensajes del chat:", error_1);
